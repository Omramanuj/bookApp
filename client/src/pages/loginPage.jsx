  ...
  return (
    <div className="h-screen w-full flex flex-col bg-gray-100 items-center justify-center">
      ...
      <div className="w-full max-w-m mt-6 flex justify-center space-x-4">
        <button
          onClick={() => window.location.href = "http://localhost:8080/google_login"}
          className="flex items-center justify-center px-6 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50"
        >
